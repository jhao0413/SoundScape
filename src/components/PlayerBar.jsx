...
export const PlayerBar = () => {
  ...
  return (
    <div className="flex flex-col bg-white/40 backdrop-blur-md border-t border-gray-200/50">
      {/* Progress Bar at Top */}
      <div className="h-1 bg-gray-200 overflow-hidden">
        <div 
          className="h-full bg-[#31c27c] transition-all duration-300"
          style={{ width: `${progressPercentage}%` }}
        />
      </div>

      {/* Player Controls */}
      <div className="h-auto sm:h-20 flex flex-col sm:flex-row items-stretch sm:items-center justify-between px-3 sm:px-4 md:px-6 py-2 sm:py-0 gap-3 sm:gap-0">
        {/* Current Music Info */}
        <div className="flex items-center gap-2 sm:gap-4 flex-1 min-w-0 order-1">
          <div className={`w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-lg sm:rounded-xl bg-gradient-to-br from-[#31c27c] to-[#28a869] flex items-center justify-center flex-shrink-0 shadow-lg ${isPlaying ? 'animate-pulse' : ''}`}>
          ...
          <div className="min-w-0 flex-1">
            ...
            {currentMusic?.artist && (
              <p className="text-xs text-gray-600 truncate hidden sm:block">{currentMusic.artist}</p>
            )}
          </div>
        </div>

        {/* Control Buttons */}
        <div className="flex items-center gap-2 sm:gap-3 md:gap-4 flex-1 justify-center order-3 sm:order-2">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4 flex-1 sm:justify-end order-2 sm:order-3">
