    ...
    <div className="flex flex-col bg-white/40 backdrop-blur-md border-t border-gray-200/50">
      ...
      <div className="h-20 flex items-center justify-between px-6">
        ...
        <div className="flex items-center gap-4 flex-1 min-w-0">
          <div className={`w-14 h-14 rounded-xl bg-gradient-to-br from-[#31c27c] to-[#28a869] flex items-center justify-center flex-shrink-0 shadow-lg ${isPlaying ? 'animate-pulse' : ''}`}>
        ...
        <div className="flex items-center gap-4 flex-1 justify-center">
          {/* Play Mode Button */}
          <div className="relative flex items-center" ref={playModeRef}>
            <button
          ...
          <button
            ...
            className="w-12 h-12 rounded-full bg-[#31c27c] hover:bg-[#28a869] text-white flex items-center justify-center transition-all shadow-lg hover:shadow-xl"
