        ...
        <div className="p-6">
          ...
          <div className="flex gap-3 mb-6">
            <div className="flex-1 relative">
              <input
                ...
                className="w-full px-4 py-3 pl-11 bg-white/50 border border-gray-200 rounded-full text-sm text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#31c27c] focus:bg-white/70 transition-all"
              />
              <svg
            ...
            <button
              ...
              className="px-6 py-3 bg-[#31c27c] hover:bg-[#28a869] text-white rounded-full text-sm font-medium transition-all shadow-md hover:shadow-lg"
            >
              搜索
            </button>
          </div>
          ...
          {selectedPlaylist && (
            <div className="flex items-center gap-2 justify-between">
              <div>
                <span className="text-sm text-gray-600">当前列表:</span>
                <span className="px-3 py-1 rounded-full text-sm font-medium bg-[#31c27c] text-white shadow-md ml-2">
                  {selectedPlaylist}
                </span>
              </div>
              <div className="flex items-center gap-3">
              <span className="text-sm text-gray-600">共 {displayList.length} 首</span>
            </div>
            </div>
          )}
        </div>
      ...
      <div className="flex-1 overflow-y-auto scrollbar-thin">
        <div className="p-6">
          {loading ? (
            ...
            <div className="bg-white/50 backdrop-blur-md rounded-2xl shadow-lg overflow-hidden border border-gray-200/50">
              <table className="w-full">
                <thead className="bg-gray-50/50 border-b border-gray-200">
                  <tr>
                    <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider w-16">#</th>
                    <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">歌曲</th>
                    <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider w-32">操作</th>
                  </tr>
                </thead>
